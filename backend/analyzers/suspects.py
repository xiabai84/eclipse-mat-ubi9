...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Analyse MAT Leak Suspects report")
    parser.add_argument("zip_file", help="Path to *_Leak_Suspects.zip")
    parser.add_argument("-o", "--output", help="Output directory")
    parser.add_argument("--json", action="store_true", help="Also save JSON data")
    args = parser.parse_args()

    try:
        analyzer = MATLeakSuspectsAnalyzer(args.zip_file, args.output)
        analyzer.analyze()
